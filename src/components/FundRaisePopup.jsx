...
//             <h2 className="text-2xl font-bold mb-4">Support Village Development</h2>
//             <p className="mb-6">"Together we can build a brighter future for our village"</p>
//             <button
//               onClick={() => setStep(2)}
...
//                 className="w-full bg-green-600 text-white px-6 py-2 rounded-full"
//               >
//                 Pay Online
//               </button>
//               <button
...
//             <img src="/path-to-qr-code.png" alt="Payment QR Code" className="mx-auto mb-4" />
//             <button
