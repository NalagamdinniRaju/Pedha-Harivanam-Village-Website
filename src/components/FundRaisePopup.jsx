  ...
  const renderStep = () => {
    switch (step) {
      case 1:
        return (
          <div className="text-center">
            ...
            <div className="text-5xl mb-4 text-green-600">🌱</div>
            <h2 className="text-2xl font-bold mb-4 flex items-center justify-center gap-2 text-gray-900 dark:text-white">
        
              Support Village Development ❤️
            </h2>
            ...
            <form onSubmit={handleSubmit}>
              <div className="relative mb-3">
                ...
                <input
                  type="text"
                  placeholder="Name"
                  className="w-full p-2 pl-10 border rounded-lg bg-gray-100 text-gray-900 dark:bg-gray-800 dark:text-white dark:border-gray-700"
                  required
                  value={formData.name}
                  onChange={(e) => setFormData({ ...formData, name: e.target.value })}
                />
              ...
              <div className="relative mb-3">
                <FaMobileAlt className="absolute left-3 top-3 text-gray-400 dark:text-gray-500" />
                <input
                  type="tel"
                  placeholder="Mobile Number"
                  className="w-full p-2 pl-10 border rounded-lg bg-gray-100 text-gray-900 dark:bg-gray-800 dark:text-white dark:border-gray-700"
              ...
              <div className="relative mb-3">
                <FaHome className="absolute left-3 top-3 text-gray-400 dark:text-gray-500" />
                <input
                  type="text"
                  placeholder="Village Name"
                  className="w-full p-2 pl-10 border rounded-lg bg-gray-100 text-gray-900 dark:bg-gray-800 dark:text-white dark:border-gray-700"
      ...
      case 3:
        return (
          <div className="text-center">
            <h3 className="text-xl font-bold mb-4 text-gray-900 dark:text-white">Choose Payment Method 💰</h3>
            <div className="space-y-3">
              <button
                onClick={() => handlePaymentMethod('online')}
                className="w-full bg-green-600 text-white px-6 py-2 rounded-full flex items-center justify-center gap-2 hover:bg-green-700 transition-colors"
      ...
      case 4:
        return (
          <div className="text-center">
            <h3 className="text-xl font-bold mb-4 text-gray-900 dark:text-white">Scan QR Code to Pay 📱</h3>
            <div className="border-4 border-green-600 rounded-lg p-2 mb-4">
              <img
                src="https://res.cloudinary.com/dwiq4s5ut/image/upload/v1734702974/PHDY_QR_CODE_v24pp4.png"
                alt="Payment QR Code"
                className="mx-auto"
              />
            </div>
      ...
      case 5:
        return (
          <div className="text-center">
            <div className="text-5xl mb-4">🙏</div>
            <h3 className="text-xl font-bold mb-4 text-gray-900 dark:text-white">Thank You!</h3>
            <p className="mb-4 text-gray-700 dark:text-gray-300">
              We've received your response and will contact you shortly regarding offline payment. ✨
            </p>
            <button
              onClick={() => setShowPopup(false)}
              className="bg-green-600 text-white px-6 py-2 rounded-full hover:bg-green-700 transition-colors"
      ...
      case 6:
        return (
          <div className="text-center">
            <div className="text-5xl mb-4">🎉</div>
            <h3 className="text-xl font-bold mb-4 text-gray-900 dark:text-white">Thank You for Your Support! 🙏</h3>
            <p className="mb-4 text-gray-700 dark:text-gray-300">
              "Your contribution will help build a better future for our village." ✨
            </p>
            <button
              onClick={() => setShowPopup(false)}
              className="bg-green-600 text-white px-6 py-2 rounded-full hover:bg-green-700 transition-colors"
      ...
      {showPopup && (
        ...
        >
          <motion.div
            ...
            animate={{ scale: 1, opacity: 1 }}
            exit={{ scale: 0.9, opacity: 0 }}
            className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-xl max-w-sm w-full"
          >
            <button
            onClick={() => setShowPopup(false)}
            className="bg-red-600 p-4 rounded-full absolute top-3 right-3 text-gray-50 shadow-lg z-[100] transition-colors duration-300 hover:bg-red-700 focus:outline-none"
            >
            <FaTimes />
            </button>
